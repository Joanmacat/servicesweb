...
from the Platform.</p>
          ...
          <p class="dark:text-gray-400">Access to the Platform implies knowledge and acceptance of these Conditions as well as
being of legal age and being of full mental capacity to be able to purchase any of the
products available through the Platform.</p>

        </div>

        <div>
          <h2 class="text-lg sm:text-xl font-semibold mb-2 dark:text-white">Access and Registration</h2>

          <p class="mb-5 dark:text-gray-400">In order to be a Platform User, it is essential that the following requirements be met:</p>
          <ul>
            <li class="dark:text-gray-400">- Have reached or been over 18 years of age.</li>
            <li class="dark:text-gray-400">- Truly complete the mandatory fields of the registration form, in which personal
data is requested (Username and email).</li>
          </ul>
...
personal and non-transferable. The User agrees not to disclose the data related to his or her
...
ANDORRACONNECT.</p>
        ...
        <div>
          <h2 class="text-lg sm:text-xl font-semibold mb-2 dark:text-white">User obligations</h2>
...
well as the principles of good faith, morality, good customs and public order. And
specifically, he undertakes to diligently observe these Conditions.</p>
          <p class="mb-5 dark:text-gray-400">Users will refrain from using the Platform for illicit purposes or effects that are harmful to the
...
<p class="mb-5 dark:text-gray-400">In general, the User undertakes, by way of example and not limitation, to:</p>
    <ul>
        <li class="dark:text-gray-400">- Not use the Platform for illegal or unauthorized purposes.</li>
        <li class="dark:text-gray-400">- Do not host, store, disclose, publish, distribute or share any content that may
involve an illegitimate interference or violation in any form of the fundamental
rights to honor, image and personal and family privacy of third parties and,
especially, minors.</li>
<li class="dark:text-gray-400">- Do not publish in any section of the Platform or in your profile or that of another User any
comment or information that is illegal, racist, xenophobic, obscene, pornographic, abusive,
defamatory, misleading, fraudulent or in any way contrary to morality or the public order.</li>
<li class="dark:text-gray-400">- Not alter or modify, totally or partially, the Platform, circumventing, deactivating or
otherwise manipulating its functions or services.</li>
<li class="dark:text-gray-400">- Not infringe industrial and intellectual property rights or the regulations governing
the protection of personal data.</li>
...
contents of the Platform.</p>
        ...
        <div>
          <h2 class="text-lg sm:text-xl font-semibold mb-2 dark:text-white">Right of withdrawal</h2>

          <p class="mb-5 dark:text-gray-400">The User will have a period of 14 calendar days to withdraw from the purchase of a
product from the date of receipt of the product to return it. Unless the return is made
due to defects or poor condition of the product, the expenses related to the return must
be assumed by the User and the product must be returned in perfect conditions without
...
of the European Parliament and of the Council, of April 27, 2016, and other applicable
...
<p class="dark:text-gray-400"><strong>Rights: </strong>Access, rectify and cancel data, as well as other rights, as
explained in the additional information.</p>
        </div>
        <div>
          <h2 class="text-lg sm:text-xl font-semibold mb-2 dark:text-white">Independence of clauses</h2>

          <p class="mb-5 dark:text-gray-400">If any of the clauses of these Conditions are null and void or voidable, it will be considered non-
enforceable. Said declaration of nullity will not invalidate the rest of the Conditions, which will
remain valid and effective between the parties.</p>
<p class="mb-5 dark:text-gray-400">If any clause of these Conditions is declared, totally or partially, null or ineffective, such nullity
or ineffectiveness will affect only said provision or the part thereof that is null or ineffective,
and the Conditions will subsist in everything else, being such provision or the part thereof
that is affected by not placing it.</p>
        </div>
        <div>
          <h2 class="text-lg sm:text-xl font-semibold mb-2 dark:text-white">Applicable legislation</h2>

          <p class="mb-5 dark:text-gray-400">These Conditions will be governed by Spanish and Andorran legislation, which will apply to what is not
provided in these Conditions in terms of interpretation, validity and execution. Likewise, both
parties submit, expressly waiving any other jurisdiction, to the Courts and Tribunals of
Barcelona.</p>
<p class="mb-5 dark:text-gray-400">The European Commission makes the online dispute resolution platform available to
