...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <div class="max-w-2xl text-center mx-auto mb-10 lg:mb-14">
    ...
    <p class="mt-1 text-gray-600 dark:text-neutral-400">Read about our articles about business and services in Andorra</p>
  </div>
  <!-- End Title -->
  ...
  <div class="grid lg:grid-cols-2 gap-6">
    <!-- Card -->
    <a class="group relative block rounded-xl" href="/article">
